...
class Chick extends MovableObject {
     ...
     * - Movement is updated ~60 times per second.
     * - Animation frames are updated every 125 milliseconds.
     */
    initMovement() {
     ...
     * 
     * @param {boolean} muted - If true, the death sound is muted; otherwise, it's unmuted.
     */
    setMute(muted) {
